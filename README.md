...
1. Среднее арифметическое чисел
   Среднее арифметическое = (x1 + x2 + ... + xn)/n, где xi- элемент последовательности, а n- количество элементов последовательности
2. Дисперсия
   Дисперсия = (y1^2 + y2^2 + ... + yn^2)/n, где yi = среднее арифметическое последовательности - xi, а n - количество элементов последовательности
